...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 28.560263, lng: 77.292362, zoom: 15, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 28.560263, lng: 77.292362, title: 'Residence',
      infoWindow: { content: '<p>D-227 Abul Fazal Enclave, Okhla, New Delhi 110025.</p>' } });
...
------------------------------------------------------*/
 ...
 $(document).ready (function (e) {
    var href = ["in", ".", "ck", "ba", "ce", "tra", "il@", "ama", "sh", ":", "to", "il", "ma"];
	$(".mailto").attr ("href", href.reverse().join (""));
 });
